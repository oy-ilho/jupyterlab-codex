...
- 서버 확장 활성화(최초 1회):
  - (Jupyter Server가 확장을 “발견”할 수 있도록) config 스니펫 설치:
    - `cp jupyter-config/jupyter_server_config.d/jupyterlab_codex.json "$(python -c 'import sys; print(sys.prefix)')/etc/jupyter/jupyter_server_config.d/jupyterlab_codex.json"`
